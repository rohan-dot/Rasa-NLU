...
class AgentOrchestrator:
    """Coordinates Scanner → Exploiter → Verifier pipeline."""

    def __init__(self, llm, call_graph, src_dir, output_dir, fuzz_seconds=120):
    ...
    def run_pipeline(self, max_scan_targets=8, max_exploit_targets=3):
        ...
        for finding in top:
            ...
            if result.crashed:
                # Phase 3: Verify
                logger.info("[pipeline] Verifying crash...")
