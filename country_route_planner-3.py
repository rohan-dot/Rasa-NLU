...
def judge_country(code, name, role, travel_date, fcg, airport=None):
    via = (f" The plan lands at airport '{airport}' here; confirm it is "
           f"listed/permitted in the entry-exit data."
           if airport and not str(airport).startswith("CENTROID:") else "")
    ans = llm_json(
