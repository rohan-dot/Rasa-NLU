...
# The judge reads BOTH the raw extracted text and the summary for each topic.
FEASIBILITY_COLS = [
    "overflight_raw", "overflight_summary",
    "entry_exit_airports_raw", "entry_exit_airports_summary",
    "customs_immigration_raw", "customs_immigration_summary",
    "diplomatic_lead_time_raw", "diplomatic_lead_time_summary",
    "airfield_restrictions_raw", "airfield_restrictions_summary",
    "operating_hours_raw", "operating_hours_summary",
    "hazmat_raw", "hazmat_summary",
    "country_specific_raw", "country_specific_summary",
]
