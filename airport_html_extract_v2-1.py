...
MAX_RETRIES   = 3
MAX_TOKENS    = 2000        # hard cap on output length -> prevents runaway generation.
                            # Scale up if you add many questions (~150 tokens/question is plenty).
INCLUDE_MISC  = True
...
def build_prompt(text: str) -> str:
    ...
    return (
        ...
        "              sentence or two) VERBATIM from the page. Do NOT copy whole sections or the page.\n"
